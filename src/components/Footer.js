...
const Footer = () => {
    return (
        <div id="footer"  className="container footer">
            <div className="row">
                <div className="col-8 text-start contact-icons">
                    <a href="tel:+1-956-607-6047" className="footerContent mx-1"><BsTelephone/></a>

                    <a href="https://goo.gl/maps/v2TucsdmAw22" className='mx-1'><SiGooglemaps/></a>
                ...
                <div className="col-4 text-end">
                    <p className="text-muted">Version 22.4.27</p>
